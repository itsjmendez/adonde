# Step 1: Create Scalable Chat Schema

## What this does
Creates new database tables for the improved chat system alongside your existing tables. Your current chat will keep working.

## Tables Created
- `conversations` - Main chat containers (direct + group support)
- `conversation_participants` - Who's in each chat
- `chat_messages` - New message storage
...
**Copy and paste this (fixed version without index conflicts):**
...
-- ========================================
-- INDEXES for Performance (avoiding conflicts)
-- ========================================
...
-- Messages (using different names to avoid conflicts)
...
- ✅ Auto-cleanup triggers set up
- ✅ Row Level Security enabled
- ✅ Your existing chat keeps working

## Next Step
Run `migration-step-2-functions.md`